    ...
    <div className="glass-panel rounded-xl p-6">
      ...
      <div className="space-y-4">
        <p className="text-neutral-700 leading-relaxed">
          {instructor.bio || 
            "This instructor hasn't added a bio yet. They are passionate about teaching and sharing their expertise with students."}
        </p>
        
        {instructor.teachingExperience && (
          <div>
            <h3 className="font-semibold text-lg">Teaching Experience</h3>
            <p className="text-neutral-700">{instructor.teachingExperience}</p>
          </div>
        )}
