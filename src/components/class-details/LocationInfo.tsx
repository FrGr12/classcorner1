...
const LocationInfo = ({
  ...
  return <section className="glass-panel rounded-xl p-8">
      <h2 className="font-bold mb-6 text-left text-2xl">Plats</h2>
      <div className="space-y-4">
        <div className="flex items-start gap-4 text-neutral-600">
          ...
          <div className="text-left">
            ...
            <p className="mt-2 text-sm">Gratis parkering tillgänglig</p>
            <p className="text-sm">5 minuters promenad från Centralstationen</p>
          </div>
        </div>
