  ...
  return (
    <section className="py-8 md:py-12">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-sans mb-6 text-left font-bold">{t("class.reviews")}</h2>
            ...
            <div className="flex flex-col h-full justify-between">
              <div>
                <div className="flex items-center mb-4">
                  ...
                  <div className="flex">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <Star 
                        key={i} 
                        className={`w-5 h-5 ${i < Math.round(Number(averageRating)) ? "fill-accent-purple text-accent-purple" : "text-gray-300"}`} 
                      />
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  {Object.entries(stats).reverse().map(([rating, count]) => (
          ...
          <div className="md:col-span-2">
            ...
            {testimonials.length > 3 && (
              <div className="mt-6 text-center">
                ...
                >
                  {showAll ? t("action.showLess") : t("action.viewMore")}
