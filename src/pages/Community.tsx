    ...
    switch (activeTab) {
      case 'groups':
        return <div className="space-y-4">
            {groupsData?.map(group => <div key={group.id} className="p-4 border rounded-lg">
          ...
          <Sheet open={sidebarOpen} onOpenChange={setSidebarOpen}>
            <SheetContent side="left" className="w-[280px] sm:w-[320px] p-0">
              <div className="h-full py-4 px-3">
                <CommunitySidebar topic={topic} category={category} resource={resource} displayedTopics={displayedTopics || []} topicsData={topicsData} groupsData={groupsData} showAllTopics={showAllTopics} onTopicClick={name => {
                ...
                setSidebarOpen(false);
              }} onShowAllTopicsToggle={() => setShowAllTopics(!showAllTopics)} onAllPostsClick={() => {
                navigate('/community/category/all');
                setSidebarOpen(false);
