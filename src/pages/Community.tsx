          ...
          <div className="grid gap-6 md:grid-cols-[300px_1fr]">
            <div className="space-y-6">
              ...
              <div className="space-y-1">
                ...
                <nav className="space-y-1">
                  {groupsData?.slice(0, 5).map(group => <button key={group.id} onClick={() => handleGroupClick(group.id)} className="w-full flex items-center justify-between px-3 py-2 text-sm hover:bg-accent rounded-lg">
